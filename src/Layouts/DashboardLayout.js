      ...
      <div className="dashboad-full">
                      ...
                      <ul className="pt-2 pb-4 space-y-1 text-sm">
                        <li className="bg-primary-focus rounded-md">
                          <Link
                            ...
                            className="flex items-center p-2 space-x-3 rounded-md text-teal-50"
                          >
                            <svg
                            ...
                            <span className="rounded-md p-2 disabled">Click to Load Orders</span>
                          </Link>
                        </li>
                      </ul>
        ...
        {isSeller ? (
          <>
            ...
            {/* tabs for menu */}
            <div className="badge badge-error badge-outline my-8">
              Click Tabs Below According to Necessary Actions
            </div>
